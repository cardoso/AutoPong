...
//#-end-hidden-code
/*:
 ## Let me guess, i just have to make the other balls kick?
 If that's what you want to do 😅 But feel free to experiment! You can make some paddles play better than others, that's how different levels of difficulty work. Again, below is an editable version of last page's code.
 After you're done, check the **Next Page** for a possible solution.
 */
